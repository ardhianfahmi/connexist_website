        ...
        <div class="breadcrumbs-custom__main bg-gray-light">
            <div class="container">
                <ul class="breadcrumbs-custom__path">
                    ...
                    <li class="active">Solusi E-Commerces </li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row row-50 justify-content-md-center">
                <div class="col-md-9 col-lg-8 col-xl-6">
                    ...
                    <p class="big">Kami menyediakan rangkaian lengkap layanan untuk perusahaan di berbagai industri. Pengembang kami memiliki pengalaman tak tertandingi dalam mengambil cara untuk mengeksplorasi dan memanfaatkan fitur untuk membangun portal e-Commerce kompetitif untuk bisnis. Kami membantu pelanggan membangun toko e-commerce yang lebih ramah untuk pengguna dan responsif melalui solusi e-Commerce holistik.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Tangkas dalam pengembangan perangkat lunak</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Perdagangan & Pemasaran secara Digital</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Integrasi Digital</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Pengembangan Produk Sumber Daya</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Modernisasi Platform</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan profesional</h5>
