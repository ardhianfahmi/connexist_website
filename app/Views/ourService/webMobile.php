...
<body>
    ...
    <section class="breadcrumbs-custom">
        <div class="breadcrumbs-custom__aside bg-image context-dark" style="background-image: url(images/bg-image-1-1920x900.jpg);">
            <div class="container">
                <h2 class="breadcrumbs-custom__title">Our Service</h2>
            </div>
        </div>
        <div class="breadcrumbs-custom__main bg-gray-light">
            <div class="container">
                <ul class="breadcrumbs-custom__path">
                    ...
                    <li class="active">Pengembangan Web dan Mobile </li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row row-50 justify-content-md-center">
                <div class="col-md-9 col-lg-8 col-xl-6">
                    ...
                    <p class="big">Sebagai perusahaan pengembangan web khusus, kami menawarkan solusi pengembangan terbaik dengan menggunakan berbagai platform. Layanan pengembangan web dan seluler kami yang fleksibel memanfaatkan kekuatan penuh dari sistem-sistem untuk memberikan daya komputasi, grafis yang ditingkatkan, standar keamanan yang kuat, dan kinerja yang lebih besar. Kami memiliki pengembang web khusus keahlian pemrograman dan pengalaman khusus industri dengan cepat, efisien, dan selaras dengan visi Anda.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Pengembangan aplikasi web/h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan pengembangan aplikasi seluler</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi aplikasi web perusahaan</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan pengembangan web bertingkat dengan lengkap</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Pengembangan portal web</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi animasi & grafis web desain</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan integrasi web</h5>
                                <p>All our products have high usability allowing users to easily operate the apps.</p>
                            </div>
                        </div>
                    </article>
