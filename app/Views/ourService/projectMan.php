        ...
        <div class="container">
            <div class="row row-50 justify-content-md-center">
                <div class="col-md-9 col-lg-8 col-xl-6">
                    ...
                    <p class="big">Kami tangkas dalam menyediakan layanan implementasi, dengan menggunakan metodologi dan skema yang telah terbukti untuk memastikan pengiriman aplikasi yang paling efisien dan hemat biaya kepada pengguna. Tim kami menggunakan praktik terbaik yang terdokumentasi untuk instalasi, konfigurasi, pengemasan server build, pengujian sebelum dan sesudah penempatan, tata kelola proyek, pemecahan masalah yang cepat, dan integrasi sistem.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan Perencanaan Penempatan</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi Implementasi Bertahap</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Penerapan Berkelanjutan</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Layanan Pasca Penempatane</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi Kompatibilitas dan Konfigurasi</h5>
