        ...
        <div class="container">
            <div class="row row-50 justify-content-md-center">
                <div class="col-md-9 col-lg-8 col-xl-6">
                    ...
                    <p class="big">Engineer QA kami berdedikasi memahami bahwa dengan pertumbuhan eksponensial dan diversifikasi data sensitif, regulasi datar yang kompleks, dan dorongan terus-menerus menuju pengumpulan sumber data oleh departemen, risiko pelanggaran keamanan dan tumbuhnya pencurian IP baru. Itu sebabnya kami memberikan solusi pemrograman protokol keamanan dan mungkin QA yang paling menyeluruh.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi Keamanan software</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Manajemen Identitas dan Akses</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Tata Kelola, Risiko dan Kepatuhan</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi Keamanan Aplikasi</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Keamanan Cyber dan Infrastruktur</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <article class="box-alice">
                        <div class="box-alice__inner">
                            ...
                            <div class="box-alice__main">
                                <h5 class="box-alice__title">Solusi Pengujian Keamanan</h5>
