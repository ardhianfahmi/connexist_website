            ...
            <article class="blog-layout">
                <div class="blog-layout__main">
                    <article class="post-single">
                        ...
                        <h4 class="post-single__title">Benefits Of Async/Await In Asynchronous Programming: Expert Opinion</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p><img src="<?= base_url('public/assets/images/blog-post-1-715x417.jpg') ?>" alt="" width="715" height="417" />
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <article class="quote-classic quote-classic_secondary">
                            <div class="quote-classic__body">
                                <svg class="quote-classic__mark" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="21px" height="15px" viewbox="0 0 21 15" overflow="scroll" xml:space="preserve" preserveAspectRatio="none">
                                ...
                                <div class="quote-classic__text">
                                    <p>Async/Await can increase the performance and responsiveness of your application, particularly when you have long-running operations.</p>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="section-md section-collapse">
                        ...
                        <div class="row row-50">
                            <div class="col-md-6">
                                <!-- Post Minimal-->
                                <article class="post-minimal"><a class="post-minimal__media" href="blog-post.html"><img class="post-minimal__image" src="<?= base_url('public/assets/images/single-post-2-368x293.jpg') ?>" alt="" width="368" height="293" /></a>
                                    <h4 class="post-minimal__title"><a href="blog-post.html">Key Considerations and Warnings of iPaaS</a></h4>
                            ...
                            <div class="col-md-6">
                                <!-- Post Minimal-->
                                <article class="post-minimal"><a class="post-minimal__media" href="blog-post.html"><img class="post-minimal__image" src="<?= base_url('public/assets/images/single-post-3-368x293.jpg') ?>" alt="" width="368" height="293" /></a>
                                    <h4 class="post-minimal__title"><a href="blog-post.html">Usage of Hibernate Query Language (HQL)</a></h4>
                                    <ul class="post-minimal__meta">
                                        <li><span class="icon mdi mdi-comment-outline"></span><a href="blog-post.html">450</a></li>
                                        <li><span class="icon mdi mdi-thumb-up-outline"></span><a href="#">12</a></li>
                                        <li><span class="icon mdi mdi-account"></span><span>by</span><a href="#">John Doe</a></li>
                    ...
                    <div class="section-md section-collapse">
                        ...
                        <div class="comment-group">
                            ...
                            <article class="comment">
                                <div class="comment__figure"><img class="comment__image" src="<?= base_url('public/assets/images/user-1-82x82.jpg') ?>" alt="" width="82" height="82" />
                                </div>
                            ...
                            <div class="comment-group">
                                <!-- Comment-->
                                <article class="comment">
                                    <div class="comment__figure"><img class="comment__image" src="<?= base_url('public/assets/images/user-2-82x82.jpg') ?>" alt="" width="82" height="82" />
                                    </div>
                                    <div class="comment__main">
                                        <div class="comment__header">
                        ...
                        <div class="comment-group">
                            <!-- Comment-->
                            <article class="comment">
                                <div class="comment__figure"><img class="comment__image" src="<?= base_url('public/assets/images/user-3-82x82.jpg') ?>" alt="" width="82" height="82" />
                                </div>
                                <div class="comment__main">
                                    <div class="comment__header">
                                        <h5 class="comment__title">Eric</h5><span class="comment__time">2 days ago</span>
                                    </div>
                                    <div class="comment__text">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                        ...
                        <div class="comment-box">
                            <div class="unit flex-md-row">
                                <div class="unit__left"><img class="comment-box__image" src="<?= base_url('public/assets/images/user-4-82x82.jpg') ?>" alt="" width="82" height="82" />
                                </div>
                ...
                <div class="blog-layout__aside">
                    <div class="blog-layout__aside-item">
                        <!-- RD Search-->
                        <form class="rd-search rd-search_inline form_lg form_outline" action="search-results.html" method="GET">
                            <div class="form-wrap">
                        ...
                        <ul class="list-posts">
                            <li>
                                ...
                                <article class="post-line">
                                    <time class="post-line__time" datetime="2019"><span class="post-line__time-day">24</span><span class="post-line__time-month">may</span></time>
                                    <div class="post-line__title"><a href="blog-post.html">Startup Software Development</a></div>
                                </article>
                            </li>
                            <li>
                                <!-- Post Line-->
                                <article class="post-line">
                                    <time class="post-line__time" datetime="2019"><span class="post-line__time-day">12</span><span class="post-line__time-month">may</span></time>
                                    <div class="post-line__title"><a href="blog-post.html">Hybrid Cloud Management Software Solutions</a></div>
                                </article>
                            </li>
                            <li>
                                <!-- Post Line-->
                                <article class="post-line">
                                    <time class="post-line__time" datetime="2019"><span class="post-line__time-day">03</span><span class="post-line__time-month">may</span></time>
                                    <div class="post-line__title"><a href="blog-post.html">Creating Better Software Through Design Thinking</a></div>
                                </article>
                            </li>
                        </ul>
                    </div>
                    <div class="blog-layout__aside-item blog-layout__aside-item_bordered">
                        ...
                        <select class="form-input select" data-placeholder="All" data-minimum-results-for-search="Infinity" data-constraints="@Required">
                            ...
                            <option value="5">March 2019</option>
                        </select>
                    </div>
                    <div class="blog-layout__aside-item"><a class="link-banner" href="#"><img src="<?= base_url('public/assets/images/banner-305x302.jpg') ?>" alt="" width="305" height="302" /></a></div>
                </div>
            </article>
        </div>
    </section>
